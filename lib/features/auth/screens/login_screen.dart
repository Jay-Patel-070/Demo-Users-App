...
import 'package:demo_users_app/features/auth/bloc/auth_bloc.dart';
import 'package:demo_users_app/features/auth/bloc/auth_event.dart';
import 'package:demo_users_app/features/auth/bloc/auth_state.dart';
import 'package:demo_users_app/features/auth/data/auth_datarepository.dart';
...
import 'package:demo_users_app/features/auth/screens/signup_screen.dart';
      ...
      listener: (context, state) async{
        if (state.apicallstate == LoginApiCallState.success) {
         await sharedprefshelper.saveData(LocalStorageKeys.accessToken, state.loginresponsemodel?.accessToken);
          print('saved user access token to local data :- ${state.loginresponsemodel?.accessToken.toString()}');
